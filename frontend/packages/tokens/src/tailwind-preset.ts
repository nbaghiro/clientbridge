    ...
    theme: {
        extend: {
            colors: {
                ...
                success: "var(--success)",
                ok: { DEFAULT: "var(--ok-fg)", bg: "var(--ok-bg)", fg: "var(--ok-fg)" },
                warn: { DEFAULT: "var(--warn-fg)", bg: "var(--warn-bg)", fg: "var(--warn-fg)" },
                danger: { DEFAULT: "var(--dan-fg)", bg: "var(--dan-bg)", fg: "var(--dan-fg)" },
                side: { DEFAULT: "var(--side)", ink: "var(--side-ink)" },
                logo: "var(--logo)",
                scrim: "rgba(20,25,30,0.35)",
            },
            fontFamily: {
