...
Pet grooming & daycare. **GST 5% + PST 7%** (exercises line-level Canadian tax). **268 rows across all
...
| **Clients** | 12 — avatars, tags (vip/regular/new/churn-risk), CASL consents |
